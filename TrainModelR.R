...
training_set=flow_images_from_directory('Dataset-Custom/train',generator = train_datagen, target_size = c(64,64),batch_size = 32, class_mode = 'categorical')
test_set=flow_images_from_directory('Dataset-Custom/test',generator = test_datagen, target_size = c(64,64),batch_size = 32, class_mode = 'categorical')
